            ...
            <div data-page="form" class="page">
                <div class="page-content">
                    ...
                    <div id="pages_maincontent">
                        ...
                        <h2 class="page_title">FORM RECOVERY PASSWORD</h2>
                        ...
                        <div class="page_single layout_fullwidth_padding">
                            ...
                            <div class="contactform">
                                <form class="" id="CustomForm" method="post" action="<?= base_url('recovery/aksi_recovery') ?>">
                                    <div class="form_row">
            
                                        <input type="hidden" name="recovery" value="<?= $recovery ?>" class="form_input" />
                                    </div>
