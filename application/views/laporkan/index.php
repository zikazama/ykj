            ...
            <div data-page="form" class="page">
                <div class="page-content">
                    ...
                    <div id="pages_maincontent">
                        ...
                        <h2 class="page_title">FORM LAPORKAN POSTINGAN</h2>
                        ...
                        <div class="page_single layout_fullwidth_padding">
                            ...
                            <div class="contactform">
                                <form class="" id="CustomForm" method="post" action="<?= base_url('laporkan/aksi_laporkan/'.$id_post) ?>">
                                   

                                    <div class="form_row">
                                        <label>Alasan Melaporkan:</label>
                                        <input type="text" name="alasan" value="" class="form_input" />
                                    </div>



                                    <input type="submit" name="submit" class="form_submit" id="submit" value="Laporkan" />
                                </form>
                            </div>
