            ...
            <div data-page="blogsingle" class="page">
                <div class="page-content">
                    ...
                    <div id="pages_maincontent">
                        ...
                        <a href="<?= base_url('pemberitahuan') ?>" class="backto"><img src="<?= base_url() ?>assets/images/icons/black/back.png" alt="" title="" /></a>
                            ...
                            <div class="tabs">
                                ...
                                <div class="tab">
                                    <div class="contactform">
                                        <form id="CommentForm" method="post" action="<?= base_url('postinganku/aksi_komentar/' . $this->uri->segment(3)) ?>">
